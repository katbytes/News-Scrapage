    ...
    $.ajax({
      ...
      if (data.comment.length > 0) {
        $.each(data.comment, function(index, value) {
          $("#comments").append(
            '<li class="collection-item"><div class="chip"><img src="images/anonymous.png" alt="Anonymous"> Anonymous</div>' +
              value.comment +
              '<a href="#" id="remove-comment" class="right" data-comment="' +
              value._id +
              '"><i class="material-icons orange-text">delete</i></a></li>'
          );
        });
      } else {
